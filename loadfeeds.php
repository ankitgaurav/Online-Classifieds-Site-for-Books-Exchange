...
if (isset($_GET['category'])) {
    ...
    if($post_year=="All"){
        ...
        $query = "SELECT * FROM post WHERE user_id<> '0' and (post_department='$post_department' or post_department='Any Branch') and (post_year='$post_year') and deleted=false";
    }
    ...
    $sql= "SELECT * FROM post WHERE user_id<> '0' and (post_department='$post_department' or post_department='Any Branch') and deleted=false ORDER BY post_time DESC LIMIT $start, $limit";
        ...
        $sql= "SELECT * FROM post WHERE user_id<> '0' and (post_department='$post_department' or post_department='Any Branch') and (post_year='$post_year') and deleted=false ORDER BY post_time DESC LIMIT $start, $limit";
    }
}
else{
    if($post_year=="All"){
    ...
    $query = "SELECT * FROM post WHERE user_id<> '0' and post_year='$post_year' and deleted=false";
    }
    $total_pages = mysqli_num_rows(mysqli_query($conn,$query));
    $targetpage = "index.php";
    $limit = 15;
    ...
    $sql= "SELECT * FROM post WHERE user_id<> '0' and deleted=false and post_year='$post_year' ORDER BY post_time DESC LIMIT $start, $limit";
