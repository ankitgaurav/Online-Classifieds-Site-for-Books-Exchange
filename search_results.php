...
<html>
	<head>
		<title>Handybooks:Search Books</title>
	</head>
	<meta charset="utf-8">
...
$('#department select').on('change', function (e) {
    selectDepartment = $("#department option:selected").val();
    updatePosts(optsYear,selectDepartment);
});
function updatePosts(year,department){
...
var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.open("GET", "filter_search_results.php?search_keyword="+search_keyword+"&filterYear="+year+"&filterDepartment="+department, true);
        xmlhttp.send();
}
</script>
	</body>
