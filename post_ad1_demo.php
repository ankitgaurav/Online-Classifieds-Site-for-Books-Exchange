...
include 'files/config.php';
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //end of code for input of image
    //data insert here
    $sql = "INSERT INTO post (user_id, post_category, post_name, post_author, post_year, post_department, post_description, post_genre, post_price, post_issue, post_class, post_subject, post_type,image_upload, image_path) VALUES ('$user_id', '$b_category', '$b_title', '$b_author', '$b_year', '$b_department', '$b_description', '$b_genre', '$b_price', '$b_issue', '$b_class', '$b_subject', '$optradio', '$img_upload', '$img_path')";
...
if(isset($_SESSION["user_id"])){ echo '
        ...
        ;}
          ...
          <li class="active"><a href="post_a_book"><i class="fa fa-book"></i> Post a Book</a></li>';
        }
        ?>
        </ul>
    </div>
...
<!--  magazine section starts
 -->      <div id="Magazine" class="tab-pane fade">
    ...
    <div class="form-group">
      ...
      <p class="help-block">Images make your post authentic</p>
    </div>
    <div class="row form-group">
    <div class="col-md-4">
